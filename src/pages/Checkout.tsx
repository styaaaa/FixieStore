...
const Checkout = () => {
  ...
  const highlightCards = [
    ...
    {
      title: "Dukungan 24/7",
      description: "Tim kami siap membantu mulai dari pembayaran hingga pengiriman.",
      Icon: Package,
    },
    {
      title: "Pengiriman terintegrasi",
      description: "Lacak paket langsung dari dashboard begitu pesanan dibuat.",
      Icon: Truck,
    },
  ];
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.error("Gagal memproses pesanan", {
        description: "Periksa kembali data dan coba beberapa saat lagi.",
      });
    } finally {
      setSubmitting(false);
    }
        ...
        <main className="container mx-auto px-4 py-12">
          <Card className="mx-auto max-w-2xl border-border/60 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Kami sedang memuat informasi akun dan keranjang.</CardDescription>
            </CardHeader>
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/40">
        <div className="border-b bg-background/80 backdrop-blur">
          <div className="container mx-auto flex items-center gap-3 px-4 py-5">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Checkout</p>
              <h1 className="text-xl font-semibold">Masuk untuk menyelesaikan pesanan</h1>
            </div>
          </div>
        </div>
        ...
        <main className="container mx-auto px-4 py-12">
          <Card className="mx-auto max-w-2xl border-border/60 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Masuk atau daftar terlebih dahulu agar detail pengirimanmu tersimpan aman di Supabase.
              </CardDescription>
            </CardHeader>
      ...
      <div className="border-b bg-background/80 backdrop-blur">
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-4 px-4 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Checkout</p>
              <h1 className="text-xl font-semibold">Lengkapi detail pengiriman</h1>
              <p className="text-sm text-muted-foreground">Pastikan informasi sudah benar sebelum membayar</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <Card className="border-border/70 shadow-sm">
              <CardHeader>
                ...
                <CardDescription>Kami akan menggunakan detail ini untuk memproses pengiriman.</CardDescription>
              </CardHeader>
              <CardContent>
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Same Day">Same day (Jakarta & sekitarnya)</SelectItem>
                        </SelectContent>
                      </Select>
                      <p className="text-xs text-muted-foreground">Biaya pengiriman disesuaikan alamat tujuan.</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="Transfer Bank">Transfer bank (VA)</SelectItem>
                          <SelectItem value="Kartu Kredit">Kartu kredit / debit</SelectItem>
                          <SelectItem value="E-Wallet">E-Wallet (OVO, Gopay, DANA)</SelectItem>
                          <SelectItem value="COD">Bayar di tempat (COD)</SelectItem>
                        </SelectContent>
                      </Select>
                      <p className="text-xs text-muted-foreground">Pembayaran aman dengan enkripsi end-to-end.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Button type="submit" size="lg" disabled={submitting || cartItems.length === 0 || cartLoading}>
                      {submitting ? "Memproses pesanan..." : "Konfirmasi & bayar"}
                    </Button>
                    <Button variant="outline" type="button" onClick={() => navigate("/cart")}>Kembali ke keranjang</Button>
            ...
            <Card className="border-border/70 bg-gradient-to-br from-card to-background shadow-sm">
              <CardHeader>
                ...
                <CardDescription>Kami berkomitmen memberikan pengalaman checkout yang elegan dan aman.</CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  {cartLoading ? (
                    ...
                    <div className="space-y-3">
                      {cartItems.map((item) => (
                        <div key={item.id} className="flex items-start justify-between rounded-lg border bg-card/60 p-3">
                          <div className="space-y-1">
                            <p className="text-sm font-semibold">{item.product?.name ?? "Produk tanpa nama"}</p>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-muted-foreground">Akan dihitung otomatis</span>
                  </div>
